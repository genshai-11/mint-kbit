    ...
    <footer className={s.footer}>
      <div className="container">
        <div className={s.footerHeader}>
          ...
          <div>
            <p className={s.footerOverline}>{tr('Korean Beauty International Technology', locale)}</p>
            <h2 className={s.footerHeading}>{tr('Clinical education, partnerships, and global exchange.', locale)}</h2>
          </div>
          <div className={s.footerActions}>
            <NavLink to={`/${locale}/contact`} className={s.footerAction}>
              <EnvelopeSimple size={18} weight="regular" aria-hidden="true" />
              {tr('Contact KBIT', locale)}
            </NavLink>
        ...
        <div className={s.grid}>
          <div className={s.brand}>
            ...
            <p className={s.tagline}>
              {tr('Korean Beauty International Technology Association — advancing clinical excellence across Korea, Vietnam, and beyond.', locale)}
            </p>
          ...
          <div className={s.col}>
            <p className={s.colTitle}>{tr('Association', locale)}</p>
            <div className={s.colLinks}>
